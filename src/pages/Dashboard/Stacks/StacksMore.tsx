    ...
    <div className="p-5 h-screen">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-4">
          <Button onClick={() => setDelModal(true)} className="bg-red-500! hover:bg-red-600! transition-all" type="primary" size="large" icon={<DeleteFilled />} />
      ...
      <div className="w-[60%] mx-auto space-y-4 p-8 rounded-2xl shadow-lg border border-slate-300 bg-white">
